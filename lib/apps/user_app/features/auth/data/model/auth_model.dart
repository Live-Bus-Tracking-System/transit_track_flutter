...
class UserAuthModel extends Auth{
  ...
  UserAuthModel({required super.id, required super.email,required super.password});
  factory UserAuthModel.fromJson(Map<String,dynamic>fromMap){
    return UserAuthModel(id: fromMap["id"], email: fromMap["email"], password: fromMap["password"]);
  }
