...
import 'package:transit_track_flutter/apps/admin_app/presentation/widget/permit/row.dart';
                        ...
                        children: [
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                head1('Permit Management', w(0.034)),
                                head3(
                                  'Orchestrate system-wide compliance through kinetic workflow tracking and automated renewal cycles.',
                                  w(0.014),
                                ),
                              ],
                            ),
