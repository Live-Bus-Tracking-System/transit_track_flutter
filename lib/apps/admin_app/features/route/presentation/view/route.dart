...
import 'package:transit_track_flutter/core/constants/strings/admin/route_strings.dart';
                        ...
                        children: [
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                head3(
                                  RouteStrings.structure,
                                  w(0.014),
                                  AppTheme.color,
                                ),
                                head1(RouteStrings.routeHead, w(0.034)),
                                head3(RouteStrings.content, w(0.014)),
                              ],
                            ),
                          ),
                      ...
                      Row(
                        ...
                        children: [
                          overContainer(
                            ...
                            SizedBox(),
                            w(0.12),
                            const Color.fromARGB(255, 35, 34, 56),
                          ),
                          overContainer(
                            w(0.2),
                            h(0.55),
